...
// Jika x > bil3 maka x adalah max dari semua bilangan. Jika tidak, maka bil3 yang max.
...
echo "<p><b>Cara 1:</b> Nilai maksimum dari ".$bilangan1.", ".$bilangan2.", dan ".$bilangan3." adalah : ".$maxAkhir."</p>";
...
echo "<p><b>Cara 2:</b> Nilai maksimum dari ".$bilangan1.", ".$bilangan2.", dan ".$bilangan3." adalah : ".$maxAkhir."</p>";
...
echo "<p><b>Cara 3:</b> Nilai maksimum dari ".$bilangan1.", ".$bilangan2.", dan ".$bilangan3." adalah : ".$maxAkhir."</p>";
?>
